...
import static io.trino.tpcds.column.WebReturnsColumn.WR_ITEM_SK;
import static io.trino.tpcds.column.WebReturnsColumn.WR_ORDER_NUMBER;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PADDING_DECIMAL1;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PADDING_DECIMAL10;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PADDING_DECIMAL11;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PADDING_DECIMAL12;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PADDING_DECIMAL13;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PADDING_DECIMAL2;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PADDING_DECIMAL3;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PADDING_DECIMAL4;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PADDING_DECIMAL5;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PADDING_DECIMAL6;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PADDING_DECIMAL7;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PADDING_DECIMAL8;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PADDING_DECIMAL9;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PADDING_INT1;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PADDING_INT2;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PADDING_INT3;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PADDING_INT4;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PADDING_INT5;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PADDING_INT6;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PADDING_INT7;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PADDING_INT8;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PADDING_INT9;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PRICING_EXT_SHIP_COST_FLAGS;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PRICING_EXT_SHIP_COST_NUMBER;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PRICING_EXT_SHIP_COST_PRECISION;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PRICING_EXT_SHIP_COST_SCALE;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PRICING_EXT_TAX_FLAGS;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PRICING_EXT_TAX_NUMBER;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PRICING_EXT_TAX_PRECISION;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PRICING_EXT_TAX_SCALE;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PRICING_FEE_FLAGS;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PRICING_FEE_NUMBER;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PRICING_FEE_PRECISION;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PRICING_FEE_SCALE;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PRICING_NET_LOSS_FLAGS;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PRICING_NET_LOSS_NUMBER;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PRICING_NET_LOSS_PRECISION;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PRICING_NET_LOSS_SCALE;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PRICING_NET_PAID_FLAGS;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PRICING_NET_PAID_INC_TAX_FLAGS;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PRICING_NET_PAID_INC_TAX_NUMBER;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PRICING_NET_PAID_INC_TAX_PRECISION;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PRICING_NET_PAID_INC_TAX_SCALE;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PRICING_NET_PAID_NUMBER;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PRICING_NET_PAID_PRECISION;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PRICING_NET_PAID_SCALE;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PRICING_QUANTITY;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PRICING_REFUNDED_CASH_FLAGS;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PRICING_REFUNDED_CASH_NUMBER;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PRICING_REFUNDED_CASH_PRECISION;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PRICING_REFUNDED_CASH_SCALE;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PRICING_REVERSED_CHARGE_FLAGS;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PRICING_REVERSED_CHARGE_NUMBER;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PRICING_REVERSED_CHARGE_PRECISION;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PRICING_REVERSED_CHARGE_SCALE;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PRICING_STORE_CREDIT_FLAGS;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PRICING_STORE_CREDIT_NUMBER;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PRICING_STORE_CREDIT_PRECISION;
import static io.trino.tpcds.column.WebReturnsColumn.WR_PRICING_STORE_CREDIT_SCALE;
import static io.trino.tpcds.column.WebReturnsColumn.WR_REASON_SK;
import static io.trino.tpcds.column.WebReturnsColumn.WR_REFUNDED_ADDR_SK;
import static io.trino.tpcds.column.WebReturnsColumn.WR_REFUNDED_CDEMO_SK;
import static io.trino.tpcds.column.WebReturnsColumn.WR_REFUNDED_CUSTOMER_SK;
import static io.trino.tpcds.column.WebReturnsColumn.WR_REFUNDED_HDEMO_SK;
import static io.trino.tpcds.column.WebReturnsColumn.WR_RETURNED_DATE_SK;
import static io.trino.tpcds.column.WebReturnsColumn.WR_RETURNED_TIME_SK;
import static io.trino.tpcds.column.WebReturnsColumn.WR_RETURNING_ADDR_SK;
import static io.trino.tpcds.column.WebReturnsColumn.WR_RETURNING_CDEMO_SK;
import static io.trino.tpcds.column.WebReturnsColumn.WR_RETURNING_CUSTOMER_SK;
import static io.trino.tpcds.column.WebReturnsColumn.WR_RETURNING_HDEMO_SK;
import static io.trino.tpcds.column.WebReturnsColumn.WR_VALID;
import static io.trino.tpcds.column.WebReturnsColumn.WR_WEB_PAGE_SK;
