...
import static io.trino.tpcds.column.WebPageColumn.WP_ACCESS_DATE_SK;
import static io.trino.tpcds.column.WebPageColumn.WP_AUTOGEN_FLAG;
import static io.trino.tpcds.column.WebPageColumn.WP_CHAR_COUNT;
import static io.trino.tpcds.column.WebPageColumn.WP_CREATION_DATE_SK;
import static io.trino.tpcds.column.WebPageColumn.WP_CUSTOMER_SK;
import static io.trino.tpcds.column.WebPageColumn.WP_IMAGE_COUNT;
import static io.trino.tpcds.column.WebPageColumn.WP_LINK_COUNT;
import static io.trino.tpcds.column.WebPageColumn.WP_MAX_AD_COUNT;
import static io.trino.tpcds.column.WebPageColumn.WP_PADDING;
import static io.trino.tpcds.column.WebPageColumn.WP_REC_END_DATE;
import static io.trino.tpcds.column.WebPageColumn.WP_REC_START_DATE;
import static io.trino.tpcds.column.WebPageColumn.WP_TYPE;
import static io.trino.tpcds.column.WebPageColumn.WP_URL;
import static io.trino.tpcds.column.WebPageColumn.WP_WEB_PAGE_ID;
import static io.trino.tpcds.column.WebPageColumn.WP_WEB_PAGE_SK;
import static io.trino.tpcds.column.WebPageColumn.WP_WEB_SITE_ID;
