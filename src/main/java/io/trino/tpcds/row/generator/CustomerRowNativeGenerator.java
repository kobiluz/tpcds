...
import static io.trino.tpcds.column.CustomerColumn.C_BIRTH_COUNTRY;
import static io.trino.tpcds.column.CustomerColumn.C_BIRTH_DAY;
import static io.trino.tpcds.column.CustomerColumn.C_BIRTH_MONTH;
import static io.trino.tpcds.column.CustomerColumn.C_BIRTH_YEAR;
import static io.trino.tpcds.column.CustomerColumn.C_CURRENT_ADDR_SK;
import static io.trino.tpcds.column.CustomerColumn.C_CURRENT_CDEMO_SK;
import static io.trino.tpcds.column.CustomerColumn.C_CURRENT_HDEMO_SK;
import static io.trino.tpcds.column.CustomerColumn.C_CUSTOMER_ID;
import static io.trino.tpcds.column.CustomerColumn.C_CUSTOMER_SK;
import static io.trino.tpcds.column.CustomerColumn.C_EMAIL_ADDRESS;
import static io.trino.tpcds.column.CustomerColumn.C_FIRST_NAME;
import static io.trino.tpcds.column.CustomerColumn.C_FIRST_SALES_DATE_SK;
import static io.trino.tpcds.column.CustomerColumn.C_FIRST_SHIPTO_DATE_SK;
import static io.trino.tpcds.column.CustomerColumn.C_LAST_NAME;
import static io.trino.tpcds.column.CustomerColumn.C_LAST_REVIEW_DATE_SK;
import static io.trino.tpcds.column.CustomerColumn.C_LOGIN;
import static io.trino.tpcds.column.CustomerColumn.C_PADDING;
import static io.trino.tpcds.column.CustomerColumn.C_PREFERRED_CUST_FLAG;
import static io.trino.tpcds.column.CustomerColumn.C_SALUTATION;
