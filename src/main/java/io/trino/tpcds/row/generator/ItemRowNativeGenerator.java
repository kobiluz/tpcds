...
import static io.trino.tpcds.column.ItemColumn.I_BRAND;
import static io.trino.tpcds.column.ItemColumn.I_BRAND_ID;
import static io.trino.tpcds.column.ItemColumn.I_CATEGORY;
import static io.trino.tpcds.column.ItemColumn.I_CATEGORY_ID;
import static io.trino.tpcds.column.ItemColumn.I_CLASS;
import static io.trino.tpcds.column.ItemColumn.I_CLASS_ID;
import static io.trino.tpcds.column.ItemColumn.I_COLOR;
import static io.trino.tpcds.column.ItemColumn.I_CONTAINER;
import static io.trino.tpcds.column.ItemColumn.I_CURRENT_PRICE_FLAGS;
import static io.trino.tpcds.column.ItemColumn.I_CURRENT_PRICE_NUMBER;
import static io.trino.tpcds.column.ItemColumn.I_CURRENT_PRICE_PRECISION;
import static io.trino.tpcds.column.ItemColumn.I_CURRENT_PRICE_SCALE;
import static io.trino.tpcds.column.ItemColumn.I_FORMULATION;
import static io.trino.tpcds.column.ItemColumn.I_ITEM_DESC;
import static io.trino.tpcds.column.ItemColumn.I_ITEM_ID;
import static io.trino.tpcds.column.ItemColumn.I_ITEM_SK;
import static io.trino.tpcds.column.ItemColumn.I_MANAGER_ID;
import static io.trino.tpcds.column.ItemColumn.I_MANUFACT;
import static io.trino.tpcds.column.ItemColumn.I_MANUFACT_ID;
import static io.trino.tpcds.column.ItemColumn.I_PADDING1;
import static io.trino.tpcds.column.ItemColumn.I_PADDING2;
import static io.trino.tpcds.column.ItemColumn.I_PRODUCT_NAME;
import static io.trino.tpcds.column.ItemColumn.I_PROMO_SK;
import static io.trino.tpcds.column.ItemColumn.I_REC_END_DATE;
import static io.trino.tpcds.column.ItemColumn.I_REC_START_DATE;
import static io.trino.tpcds.column.ItemColumn.I_SIZE;
import static io.trino.tpcds.column.ItemColumn.I_UNITS;
import static io.trino.tpcds.column.ItemColumn.I_WHOLESALE_COST_FLAGS;
import static io.trino.tpcds.column.ItemColumn.I_WHOLESALE_COST_NUMBER;
import static io.trino.tpcds.column.ItemColumn.I_WHOLESALE_COST_PRECISION;
import static io.trino.tpcds.column.ItemColumn.I_WHOLESALE_COST_SCALE;
